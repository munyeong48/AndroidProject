...
class NextActivity : AppCompatActivity() {
    private var mFirebaseAnalytics2: FirebaseAnalytics? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mWebView1.loadUrl("http://210.114.9.22/GA_part/myshin/gav4.html") // 웹뷰에 표시할 웹사이트 주소, 웹뷰 시작
    ...
    override fun onResume() {
        ...
        bundle.putString(FirebaseAnalytics.Param.SCREEN_NAME, "0610_main2") //보고서-페이지 제목 및 화면 이름 or 이벤트-firebase_screen
        bundle.putString(FirebaseAnalytics.Param.SCREEN_CLASS, "0610_main2") //보고서-이벤트-screen_view-firebase_screen_class
